...
<title>Paul Curtis || Philadelphia, PA || https://www.PaulCurtis.us/</title>
...
<?php//TODO: PAGE CONTENT GOES HERE AND IS SWAPPED JS?>
<div class='view full-page-intro'
	style='text-align: center; vertical-align:middle; background-image: url("resources/img/78.jpg"); background-repeat: no-repeat; background-size: cover;'>
	<div
...
<footer class='page-footer text-center font-small wow fadeIn'>
	...
	<div class='pb-4'>
		<a href='https://linkedin.com/in/paulcphilly/' target='_blank'> <img
			...
			alt='Git' src='resources/img/GitHub-Mark-64px.png' /> </a>
	</div>
